  ...
  .then(data => {
      if (data.full_name) {
          ...
          setTimeout(() => {
              ...
              createPremiumPage(templateOwner, newRepoName, token);
          }, 3000); 
...
// Aquí sigue la función createPremiumPage como la tienes.


function createPremiumPage(owner, repo, token) {
