...
grid-content p {
  ...
  flex-container#${grid_content_id}{
    display: flex;
    flex-wrap: wrap;
  ...
  flex-container#${grid_content_id} flex-box1 img {
    width: 100%;
    height: 100%;
    object-fit: cover;
  }
  ...
  <section id="${grid_section_id}" data-type="section">
      ...
      <grid-bg id="${grid_bg}" data-type="grid-bg">
          ...
          <div id="${bg_color}" data-type="bg-color" class="div-visible">
            <div id="${bg_solid_color}" data-type="solid-color" class="div-visible" style="background: rgb(0, 115, 255);"></div>
      ...
      <!--HTML-->
      <grid-container id="${grid_container_id}" data-type="html">
      
      <flex-container id="${grid_content_id}" contenteditable="true">
        <p class="grid-id-info no-export">grid-content: ${grid_content_id}</p>
      </flex-container>

      <div class="flex-edit-buttons no-export"> 
      
      

      <button class = "grid-cols-button" onclick="openFlexItems('${grid_content_id}', 'beforeend')">flex</button>
