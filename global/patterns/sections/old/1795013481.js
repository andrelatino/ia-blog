  ...
  function _1795013481() { 
    ...
    @media screen and (min-width:0px){#${div1Css}{display:block;margin: 0px 20px;}}
    @media screen and (min-width:0px){#${h2Css}{font-size: clamp(2.5rem, 4.5vw, 7.5rem); font-weight: 200; color: black; background: #FFEB3B; padding: 0px 0; line-height: 1.45; display: inline;}}
    ...
    <div id="${containerID}" data-type="container">
        ...
        <div id="${generateRandomID(7)}" data-type="bg-video" class="div-visible">
          <video id="${videoID}" autoplay loop muted loading="lazy">
            <source src="https://github.com/IAMEDIA360/videos/raw/main/1795013481-1.mp4" type="video/mp4">
          </video>
        </div> <!-- bg-video -->
      ...
      <div id="${contentID}" data-type="content">
        <div id="${div1ID}">
          <h2 id="${h2ID}" contenteditable="true">&nbsp;Consectur&nbsp;<br>&nbsp;lorem ipsum&nbsp;<br>&nbsp;adipiscing elit&nbsp;</h2>
        </div> <!-- div1ID -->
      </div> <!-- content -->
    </div> <!-- container -->
