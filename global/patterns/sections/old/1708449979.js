  ...
  function _1708449979() { 
    ...
    @media screen and (min-width:0px){#${contentCss}{width:100%;height:100%;display:grid;place-content: start center;}}
    @media screen and (min-width:0px){#${div1Css}{display: grid; padding: 5%; max-width:1050px;gap:20px;place-items:center;text-align: center;margin-top:100px;}}
    @media screen and (min-width:0px){#${h2Css}{font-size: clamp(3rem, 12vw, 7rem);line-height:1;font-weight:200;color: black;}}
    ...
    <div id="${containerID}" data-type="container">
        ...
        <div id="${generateRandomID(7)}" data-type="bg-image" class="div-visible">
          <picture id="${generateRandomID(7)}">
            ...
            <img id="${imageID}" src="https://raw.githubusercontent.com/IAMEDIA360/images/main/1708449979-1.jpeg" data-type="img-bg" loading="lazy">
          </picture>
        </div> <!-- bg-image -->
      ...
      <div id="${contentID}" data-type="content">
        <div id="${div1ID}">
          ...
          <p id="${pID}" contenteditable="true">Lorem ipsum dolor sit amet consectetur</p>
          <div id="${div2ID}">
