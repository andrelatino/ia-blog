  ...
  function _1710352397() { 
    ...
    const customCSS = `
    @media screen and (min-width:0px){#${sectionCss}{width:100%;height:fit-content;position:relative}}
    @media screen and (min-width:0px){#${containerCss}{width:100%;height:auto;position:relative}}
    ...
    @media screen and (min-width:0px){#${contentCss}{width:100%;height:100%;display:grid;padding:10%}}
    @media screen and (min-width:0px){#${div1Css}{display: grid; width:auto;gap:15px;place-items:center;place-content:center;text-align: center;}}
    @media screen and (min-width:0px){#${h2Css}{font-size: clamp(2rem, 4vw, 6rem);line-height:1;font-weight:200;color: white;}}
    ...
    @media screen and (min-width:0px){#${btn1Css}{border: 3px solid white; padding: 0 15px; color: white; font-size: 14px; border-radius: 10px; text-underline-position: under; height: 50px; display: grid; place-content: center;}}
    ...
    <div id="${containerID}" data-type="container">
      <div id="${generateRandomID(7)}" data-type="backgrounds">
        ...
        <div id="${colorID}" data-type="bg-color" class="div-visible">
          <div id="${solidcolorID}" data-type="solid-color" class="div-visible" style="background: rgb(0, 60, 255);"></div>
        ...
        <div id="${generateRandomID(7)}" data-type="bg-image" class="div-hidden">
          <picture id="${generateRandomID(7)}">
            ...
            <img id="${imageID}" src="https://raw.githubusercontent.com/IAMEDIA360/images/main/empty.svg" data-type="img-bg" loading="lazy">
          </picture>
        </div> <!-- bg-image -->
      ...
      <div id="${contentID}" data-type="content">
        <div id="${div1ID}">
          ...
          <p id="${pID}" contenteditable="true">Lorem ipsum dolor sit amet</p>
          <div id="${div2ID}">
