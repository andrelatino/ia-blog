  ...
  function _1710335046() { 
    ...
    @media screen and (min-width:0px){#${item2_css}{object-fit:cover;height:100%;min-height:50vh;width:100%;background:white;}}
    @media screen and (min-width:0px){#${item3_css}{object-fit:cover;height:100%;min-height:50vh;width:100%;background:white;}}
    @media screen and (min-width:0px){#${item4_css}{object-fit:cover;height:100%;min-height:50vh;width:100%;background:white;}}
    ...
    @media screen and (max-width:640px){#${item3_css}{object-fit:cover;height:100%;min-height:50vh;width:100%;display:grid;}}
    @media screen and (max-width:640px){#${item4_css}{object-fit:cover;height:100%;min-height:50vh;width:100%;display:grid;}}
