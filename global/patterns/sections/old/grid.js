    ...
    <section id="${section_id}" data-type="section">
      <style id="${generateRandomID(7)}" type="text/css">
        ...
        <div id="${grid_id}" data-type="grid">
            ...
            <img id="${item1_id}" src="https://raw.githubusercontent.com/IAMEDIA360/SVGs/main/hero.svg" data-type="img-grid" loading="lazy">
            <div id="${item2_id}">
              <h1 id="${item2_h1_id}"> Devenez Expert en IA Generative! </h1>
              <p id="${item2_p_id}"> Lorem ipsum dolor sit amet </p>
            </div>
