  ...
  function _1709064458() { 
    ...
    @media screen and (min-width:0px){#${contentCss}{width:100%;height:100%;display:grid;place-content: end center;}}
    ...
    <div id="${containerID}" data-type="container">
        ...
        <div id="${generateRandomID(7)}" data-type="bg-video" class="div-visible">
          ...
          <source src="https://github.com/IAMEDIA360/videos/raw/main/1709064458-1.mp4" type="video/mp4">
          </video>
        </div> <!-- bg-video -->
