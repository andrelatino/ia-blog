function _grid_products_175_white() {
  ...
  grid-box#${grid_box_id} product-details{
    color:grey;
    font-size:12px;
  }
      ...
      <div id="${generateRandomID(7)}" data-type="html">
        ...
        <grid-bg id="${grid_bg}" data-type="grid-bg">
          ...
          <grid-box id="${grid_box_id}">
            ...
            <button id="${add_button_id}" class="no-export grid-add-item" onclick="products175x100('${grid_box_id}','${add_button_id}', '../global/file/empty.svg')">+</button>
          </grid-box>
        </grid-container>
      </div>
