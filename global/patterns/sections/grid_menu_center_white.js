function _grid_menu_center_white() {
  ...
  `;
	...
	const customHTML = `
  <section id="${section_id}" data-type="navigation">
        ...
        <grid-nav id="${grid_nav_id}">
            ...
            <grid-item id="${item_right_menu}">
              <grid-box id="${item_right_box}">
                <button id="${item_right_add}" class="no-export grid-add-item" onclick="itemsLinks('${item_right_box}','${item_right_add}')">+</button>
              </grid-box>
            </grid-item>
  ...
  itemsLinks(item_left_box,item_left_add);
  itemsLinks(item_right_box,item_right_add);
  itemsLinks(item_right_box,item_right_add)
