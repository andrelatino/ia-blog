function _grid_text_img() {
  ...
  const item2_img = generateRandomID(7);
      ...
      <div id="${generateRandomID(7)}" data-type="html">
        ...
        <grid-box id="${grid_box_id}">
            ...
            <grid-item id="${item2_id}">
                <img id="${item2_img}" src="https://images.unsplash.com/photo-1535478044878-3ed83d5456ef?ixid=M3wzOTcwOTd8MHwxfHNlYXJjaHwxMjl8fGFic3RyYWN0fGVufDB8MHx8fDE3MTY2NjYyNDR8MA&ixlib=rb-4.0.3&w=1280&h=720&fit=crop" data-type="image-fg" loading="lazy">
            </grid-item>
