function _grid_footer_5() {
  ...
  const item_4_menu = generateRandomID(7);
  const item_4_box = generateRandomID(7);
  const item_4_add = generateRandomID(7);

  const item_5_menu = generateRandomID(7);
  const item_5_box = generateRandomID(7);
  const item_5_add = generateRandomID(7);
  ...
  <section id="${generateRandomID(7)}" data-type="section">
      ...
      <div id="${generateRandomID(7)}" data-type="html">
        ...
        <grid-box id="${grid_box_id}">
          ...
          <grid-item id="${item_4_menu}">
            <grid-box id="${item_4_box}">
              <h2 id="${generateRandomID(7)}" contenteditable="true">Title</h2>
              <button id="${item_4_add}" class="no-export grid-add-item" onclick="itemsButtons('${item_4_box}','${item_4_add}')">+</button>
            </grid-box>
          </grid-item>

          <grid-item id="${item_5_menu}">
            <grid-box id="${item_5_box}">
              <h2 id="${generateRandomID(7)}" contenteditable="true">Title</h2>
              <button id="${item_5_add}" class="no-export grid-add-item" onclick="itemsButtons('${item_5_box}','${item_5_add}')">+</button>
            </grid-box>
          </grid-item>
  ...
  const addSectionToGrid = document.getElementById('grid-body');
   ...
   itemsButtons(item_4_box,item_4_add);
   itemsButtons(item_4_box,item_4_add);

   itemsButtons(item_5_box,item_5_add);
   itemsButtons(item_5_box,item_5_add);
