...
const selectEditorElement = document.getElementById('editor-css-select');
const handleSelectChange = () => {
  extractAndDisplayId();
  console.log('Select value changed:', selectEditorElement.value);
...
// Event listener for changes in select value
selectEditorElement.addEventListener('change', handleSelectChange);
